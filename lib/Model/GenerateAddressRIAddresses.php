...
/**
 * GenerateAddressRIAddresses Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class GenerateAddressRIAddresses implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GenerateAddressRI_addresses';
     ...
     * Sets address
     *
     * @param string $address Represents the specific address that will be generated.
     *
     * @return self
     */
