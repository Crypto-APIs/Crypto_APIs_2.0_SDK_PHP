...
/**
 * GetLatestMinedBlockRIBSD2 Class Doc Comment
 *
 * @category Class
 * @description Dash
 * @package  CryptoAPIs
 ...
 */
class GetLatestMinedBlockRIBSD2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetLatestMinedBlockRIBSD2';
