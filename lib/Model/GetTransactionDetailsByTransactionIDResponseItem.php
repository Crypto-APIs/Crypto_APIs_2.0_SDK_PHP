...
/**
 * GetTransactionDetailsByTransactionIDResponseItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetTransactionDetailsByTransactionIDResponseItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTransactionDetailsByTransactionIDResponseItem';
    ...
    protected static $openAPITypes = [
        ...
        'recipients' => '\OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemRecipients[]',
        'senders' => '\OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemSenders[]',
        'timestamp' => 'int',
        'transaction_hash' => 'string',
        'transaction_id' => 'string',
        'fee' => '\OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemFee',
        'is_confirmed' => 'bool',
        'blockchain_specific' => '\OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecific'
    ];
     ...
     * Gets recipients
     *
     * @return \OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemRecipients[]
     */
     ...
     * Sets recipients
     *
     * @param \OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemRecipients[] $recipients Represents a list of recipient addresses with the respective amounts. In account-based protocols like Ethereum there is only one address in this list.
     *
     * @return self
     */
     ...
     * Gets senders
     *
     * @return \OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemSenders[]
     */
     ...
     * Sets senders
     *
     * @param \OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemSenders[] $senders Represents a list of sender addresses with the respective amounts. In account-based protocols like Ethereum there is only one address in this list.
     *
     * @return self
     */
     ...
     * Gets fee
     *
     * @return \OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemFee
     */
     ...
     * Sets fee
     *
     * @param \OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemFee $fee fee
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecific
     */
     ...
     *
     * @param \OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecific $blockchain_specific blockchain_specific
     *
     * @return self
     */
