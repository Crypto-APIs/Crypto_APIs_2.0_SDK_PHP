...
/**
 * ListTransactionsByAddressRIBSDVin Class Doc Comment
 *
 * @category Class
 * @package  CryptoAPIs
 * @author   OpenAPI Generator team
 ...
 */
class ListTransactionsByAddressRIBSDVin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListTransactionsByAddressRIBSD_vin';
    ...
    protected static $openAPITypes = [
        'addresses' => 'string[]',
        'coinbase' => 'string',
        'script_sig' => '\CryptoAPIs\Model\ListTransactionsByAddressRIBSDScriptSig',
        'sequence' => 'string',
        'txid' => 'string',
        'txinwitness' => 'string[]',
        'value' => 'string',
     ...
     * Gets script_sig
     *
     * @return \CryptoAPIs\Model\ListTransactionsByAddressRIBSDScriptSig
     */
     ...
     * Sets script_sig
     *
     * @param \CryptoAPIs\Model\ListTransactionsByAddressRIBSDScriptSig $script_sig script_sig
     *
     * @return self
     */
