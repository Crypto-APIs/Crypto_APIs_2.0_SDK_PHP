...
/**
 * ListHDWalletxPubYPubZPubTransactionsResponseItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListHDWalletxPubYPubZPubTransactionsResponseItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListHDWalletxPubYPubZPubTransactionsResponseItem';
    ...
    protected static $openAPITypes = [
        ...
        'recipients' => '\OpenAPI\Client\Model\ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients[]',
        'senders' => '\OpenAPI\Client\Model\ListHDWalletxPubYPubZPubTransactionsResponseItemSenders[]',
        'timestamp' => 'int',
        'transaction_hash' => 'string',
        'transaction_id' => 'string',
        'fee' => '\OpenAPI\Client\Model\ListHDWalletxPubYPubZPubTransactionsResponseItemFee'
    ];
     ...
     * Gets recipients
     *
     * @return \OpenAPI\Client\Model\ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients[]
     */
     ...
     * Sets recipients
     *
     * @param \OpenAPI\Client\Model\ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients[] $recipients Represents a list of recipient addresses with the respective amounts. In account-based protocols like Ethereum there is only one address in this list.
     *
     * @return self
     */
     ...
     * Gets senders
     *
     * @return \OpenAPI\Client\Model\ListHDWalletxPubYPubZPubTransactionsResponseItemSenders[]
     */
     ...
     * Sets senders
     *
     * @param \OpenAPI\Client\Model\ListHDWalletxPubYPubZPubTransactionsResponseItemSenders[] $senders Represents a list of sender addresses with the respective amounts. In account-based protocols like Ethereum there is only one address in this list.
     *
     * @return self
     */
     ...
     * Gets fee
     *
     * @return \OpenAPI\Client\Model\ListHDWalletxPubYPubZPubTransactionsResponseItemFee
     */
     ...
     * Sets fee
     *
     * @param \OpenAPI\Client\Model\ListHDWalletxPubYPubZPubTransactionsResponseItemFee $fee fee
     *
     * @return self
     */
