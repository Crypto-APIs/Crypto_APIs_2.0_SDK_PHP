...
/**
 * DeleteAutomaticCoinsForwardingResponseItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeleteAutomaticCoinsForwardingResponseItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteAutomaticCoinsForwardingResponseItem';
     ...
     *
     * @param string $created_timestamp Defines the specific time/date when the automatic forwarding was created in Unix Timestamp.
     *
     * @return self
     */
