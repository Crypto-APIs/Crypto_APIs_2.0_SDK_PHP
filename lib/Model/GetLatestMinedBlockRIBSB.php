...
/**
 * GetLatestMinedBlockRIBSB Class Doc Comment
 *
 * @category Class
 * @description Bitcoin
 * @package  CryptoAPIs
 ...
 */
class GetLatestMinedBlockRIBSB implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetLatestMinedBlockRIBSB';
