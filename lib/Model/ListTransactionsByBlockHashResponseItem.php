...
/**
 * ListTransactionsByBlockHashResponseItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListTransactionsByBlockHashResponseItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListTransactionsByBlockHashResponseItem';
    ...
    protected static $openAPITypes = [
        ...
        'recipients' => '\OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemRecipients[]',
        'senders' => '\OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemSenders[]',
        'timestamp' => 'int',
        'transaction_hash' => 'string',
        'transaction_id' => 'string',
        'fee' => '\OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemFee',
        'blockchain_specific' => '\OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemBlockchainSpecific'
    ];
     ...
     * Gets recipients
     *
     * @return \OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemRecipients[]
     */
     ...
     * Sets recipients
     *
     * @param \OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemRecipients[] $recipients Represents a list of recipient addresses with the respective amounts. In account-based protocols like Ethereum there is only one address in this list.
     *
     * @return self
     */
     ...
     * Gets senders
     *
     * @return \OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemSenders[]
     */
     ...
     * Sets senders
     *
     * @param \OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemSenders[] $senders Represents a list of sender addresses with the respective amounts. In account-based protocols like Ethereum there is only one address in this list.
     *
     * @return self
     */
     ...
     * Gets fee
     *
     * @return \OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemFee
     */
     ...
     * Sets fee
     *
     * @param \OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemFee $fee fee
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemBlockchainSpecific
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemBlockchainSpecific $blockchain_specific blockchain_specific
     *
     * @return self
     */
