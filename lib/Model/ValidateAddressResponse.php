...
class ValidateAddressResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'request_id' => 'string',
        'context' => 'string',
        'data' => '\OpenAPI\Client\Model\ValidateAddressResponseData'
    ];
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\ValidateAddressResponseData
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ValidateAddressResponseData $data data
     *
     * @return self
     */
