...
class InvalidNetwork implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'request_id' => 'string',
        'context' => 'string',
        'error' => '\OpenAPI\Client\Model\InvalidNetworkError'
    ];
     ...
     * Gets error
     *
     * @return \OpenAPI\Client\Model\InvalidNetworkError
     */
     ...
     * Sets error
     *
     * @param \OpenAPI\Client\Model\InvalidNetworkError $error error
     *
     * @return self
     */
