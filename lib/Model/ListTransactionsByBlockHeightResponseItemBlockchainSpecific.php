...
/**
 * ListTransactionsByBlockHeightResponseItemBlockchainSpecific Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListTransactionsByBlockHeightResponseItemBlockchainSpecific implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListTransactionsByBlockHeightResponseItemBlockchainSpecific';
    ...
    protected static $openAPITypes = [
        ...
        'v_size' => 'int',
        'version' => 'int',
        'vin' => '\OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin[]',
        'vout' => '\OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout[]',
        'contract' => 'string',
        'gas_limit' => 'string',
        'gas_price' => '\OpenAPI\Client\Model\ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereumClassicGasPrice',
        'gas_used' => 'string',
        'input_data' => 'string',
        'nonce' => 'string',
     ...
     * Gets vin
     *
     * @return \OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin[]
     */
     ...
     * Sets vin
     *
     * @param \OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin[] $vin Represents the transaction inputs.
     *
     * @return self
     */
     ...
     * Gets vout
     *
     * @return \OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout[]
     */
     ...
     * Sets vout
     *
     * @param \OpenAPI\Client\Model\ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout[] $vout Represents the transaction outputs.
     *
     * @return self
     */
     ...
     * Gets gas_price
     *
     * @return \OpenAPI\Client\Model\ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereumClassicGasPrice
     */
     ...
     * Sets gas_price
     *
     * @param \OpenAPI\Client\Model\ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereumClassicGasPrice $gas_price gas_price
     *
     * @return self
     */
