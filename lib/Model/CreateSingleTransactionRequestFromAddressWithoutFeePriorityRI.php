...
class CreateSingleTransactionRequestFromAddressWithoutFeePriorityRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'note' => 'string',
        'recipient' => '\CryptoAPIs\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriorityRIRecipient[]',
    ...
    const TRANSACTION_REQUEST_STATUS_MINED_WITH_ERRORS = 'mined-with-errors';
     ...
     * Gets recipient
     *
     * @return \CryptoAPIs\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriorityRIRecipient[]
     */
     ...
     * Sets recipient
     *
     * @param \CryptoAPIs\Model\CreateSingleTransactionRequestFromAddressWithoutFeePriorityRIRecipient[] $recipient Defines the destination for the transaction, i.e. the recipient(s).
     *
     * @return self
     */
