...
/**
 * GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecific Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecific implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecific';
    ...
    protected static $openAPITypes = [
        ...
        'v_size' => 'int',
        'version' => 'int',
        'vin' => '\OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashVin[]',
        'vout' => '\OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashVout[]',
        'vsize' => 'int',
        'contract' => 'string',
        'gas_limit' => 'string',
        'gas_price' => '\OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificEthereumClassicGasPrice',
        'gas_used' => 'string',
        'input_data' => 'string',
        'nonce' => 'string',
     ...
     * Gets vin
     *
     * @return \OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashVin[]
     */
     ...
     * Sets vin
     *
     * @param \OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashVin[] $vin Represents the transaction inputs.
     *
     * @return self
     */
     ...
     * Gets vout
     *
     * @return \OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashVout[]
     */
     ...
     * Sets vout
     *
     * @param \OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashVout[] $vout Represents the transaction outputs.
     *
     * @return self
     */
     ...
     * Gets gas_price
     *
     * @return \OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificEthereumClassicGasPrice
     */
     ...
     * Sets gas_price
     *
     * @param \OpenAPI\Client\Model\GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificEthereumClassicGasPrice $gas_price gas_price
     *
     * @return self
     */
