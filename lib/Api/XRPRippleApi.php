...
class XRPRippleApi
{
    ...
    public function getLatestMinedXRPRippleBlockWithHttpInfo($network, $context = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetLatestMinedXRPRippleBlockResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetLatestMinedXRPRippleBlockResponse', []),
            ...
            $returnType = '\OpenAPI\Client\Model\GetLatestMinedXRPRippleBlockResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetLatestMinedXRPRippleBlockResponse',
    ...
    public function getLatestMinedXRPRippleBlockRequest($network, $context = null)
    {
        ...
        $resourcePath = '/blockchain-data/xrp/{network}/blocks/last';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetXRPRippleAddressDetailsResponse|\OpenAPI\Client\Model\InvalidPagination|\OpenAPI\Client\Model\InvalidApiKey|\OpenAPI\Client\Model\InsufficientCredits|\OpenAPI\Client\Model\FeatureMainnetsNotAllowedForPlan|\OpenAPI\Client\Model\InvalidData|\OpenAPI\Client\Model\UnsupportedMediaType|\OpenAPI\Client\Model\InvalidRequestBodyStructure|\OpenAPI\Client\Model\RequestLimitReached|\OpenAPI\Client\Model\UnexpectedServerError
     */
    ...
    public function getXRPRippleAddressDetailsWithHttpInfo($network, $address, $context = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetXRPRippleAddressDetailsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetXRPRippleAddressDetailsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\GetXRPRippleAddressDetailsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetXRPRippleAddressDetailsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getXRPRippleAddressDetailsRequest($network, $address, $context = null)
    {
        ...
        $resourcePath = '/blockchain-data/xrp/{network}/addresses/{address}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetXRPRippleBlockDetailsByBlockHashResponse|\OpenAPI\Client\Model\InvalidPagination|\OpenAPI\Client\Model\InvalidApiKey|\OpenAPI\Client\Model\InsufficientCredits|\OpenAPI\Client\Model\FeatureMainnetsNotAllowedForPlan|\OpenAPI\Client\Model\ResourceNotFound|\OpenAPI\Client\Model\InvalidData|\OpenAPI\Client\Model\UnsupportedMediaType|\OpenAPI\Client\Model\InvalidRequestBodyStructure|\OpenAPI\Client\Model\RequestLimitReached|\OpenAPI\Client\Model\UnexpectedServerError
     */
    ...
    public function getXRPRippleBlockDetailsByBlockHashWithHttpInfo($network, $block_hash, $context = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetXRPRippleBlockDetailsByBlockHashResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetXRPRippleBlockDetailsByBlockHashResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\GetXRPRippleBlockDetailsByBlockHashResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetXRPRippleBlockDetailsByBlockHashResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getXRPRippleBlockDetailsByBlockHashRequest($network, $block_hash, $context = null)
    {
        ...
        $resourcePath = '/blockchain-data/xrp/{network}/blocks/hash/{blockHash}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $network Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \&quot;mainnet\&quot; is the live network with actual data while networks like \&quot;testnet\&quot;,  are test networks. (required)
     * @param  string $height Represents the number of blocks in the blockchain preceding this specific block. Block numbers have no gaps. A blockchain usually starts with block 0 called the \&quot;Genesis block\&quot;. (required)
     * @param  string $context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function getXRPRippleBlockDetailsByBlockHeight($network, $height, $context = null)
    {
        list($response) = $this->getXRPRippleBlockDetailsByBlockHeightWithHttpInfo($network, $height, $context);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\GetXRPRippleBlockDetailsByBlockHeightResponse|\OpenAPI\Client\Model\InvalidPagination|\OpenAPI\Client\Model\InvalidApiKey|\OpenAPI\Client\Model\InsufficientCredits|\OpenAPI\Client\Model\FeatureMainnetsNotAllowedForPlan|\OpenAPI\Client\Model\ResourceNotFound|\OpenAPI\Client\Model\InvalidData|\OpenAPI\Client\Model\UnsupportedMediaType|\OpenAPI\Client\Model\InvalidRequestBodyStructure|\OpenAPI\Client\Model\RequestLimitReached|\OpenAPI\Client\Model\UnexpectedServerError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getXRPRippleBlockDetailsByBlockHeightWithHttpInfo($network, $height, $context = null)
    {
        $request = $this->getXRPRippleBlockDetailsByBlockHeightRequest($network, $height, $context);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetXRPRippleBlockDetailsByBlockHeightResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetXRPRippleBlockDetailsByBlockHeightResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\GetXRPRippleBlockDetailsByBlockHeightResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetXRPRippleBlockDetailsByBlockHeightResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getXRPRippleBlockDetailsByBlockHeightAsync($network, $height, $context = null)
    {
        return $this->getXRPRippleBlockDetailsByBlockHeightAsyncWithHttpInfo($network, $height, $context)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getXRPRippleBlockDetailsByBlockHeightAsyncWithHttpInfo($network, $height, $context = null)
    {
        $returnType = '\OpenAPI\Client\Model\GetXRPRippleBlockDetailsByBlockHeightResponse';
        $request = $this->getXRPRippleBlockDetailsByBlockHeightRequest($network, $height, $context);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getXRPRippleBlockDetailsByBlockHeightRequest($network, $height, $context = null)
    {
        // verify the required parameter 'network' is set
        if ($network === null || (is_array($network) && count($network) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($height === null || (is_array($height) && count($height) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $height when calling getXRPRippleBlockDetailsByBlockHeight'
            );
        }

        $resourcePath = '/blockchain-data/xrp/{network}/blocks/height/{height}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getXRPRippleTransactionDetailsByTransactionIDWithHttpInfo($network, $transaction_hash, $context = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetXRPRippleTransactionDetailsByTransactionIDResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetXRPRippleTransactionDetailsByTransactionIDResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\GetXRPRippleTransactionDetailsByTransactionIDResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetXRPRippleTransactionDetailsByTransactionIDResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getXRPRippleTransactionDetailsByTransactionIDRequest($network, $transaction_hash, $context = null)
    {
        ...
        $resourcePath = '/blockchain-data/xrp/{network}/transactions/{transactionHash}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ListXRPRippleTransactionsByAddressResponse|\OpenAPI\Client\Model\InvalidPagination|\OpenAPI\Client\Model\InvalidApiKey|\OpenAPI\Client\Model\InsufficientCredits|\OpenAPI\Client\Model\FeatureMainnetsNotAllowedForPlan|\OpenAPI\Client\Model\InvalidData|\OpenAPI\Client\Model\UnsupportedMediaType|\OpenAPI\Client\Model\InvalidRequestBodyStructure|\OpenAPI\Client\Model\RequestLimitReached|\OpenAPI\Client\Model\UnexpectedServerError
     */
    ...
    public function listXRPRippleTransactionsByAddressWithHttpInfo($network, $address, $context = null, $limit = 50, $offset = 0)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ListXRPRippleTransactionsByAddressResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ListXRPRippleTransactionsByAddressResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\ListXRPRippleTransactionsByAddressResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ListXRPRippleTransactionsByAddressResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function listXRPRippleTransactionsByAddressRequest($network, $address, $context = null, $limit = 50, $offset = 0)
    {
        ...
        $resourcePath = '/blockchain-data/xrp/{network}/addresses/{address}/transactions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ListXRPRippleTransactionsByBlockHashResponse|\OpenAPI\Client\Model\InvalidPagination|\OpenAPI\Client\Model\InvalidApiKey|\OpenAPI\Client\Model\InsufficientCredits|\OpenAPI\Client\Model\FeatureMainnetsNotAllowedForPlan|\OpenAPI\Client\Model\InvalidData|\OpenAPI\Client\Model\UnsupportedMediaType|\OpenAPI\Client\Model\InvalidRequestBodyStructure|\OpenAPI\Client\Model\RequestLimitReached|\OpenAPI\Client\Model\UnexpectedServerError
     */
    ...
    public function listXRPRippleTransactionsByBlockHashWithHttpInfo($network, $block_hash, $context = null, $limit = 50, $offset = 0)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ListXRPRippleTransactionsByBlockHashResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ListXRPRippleTransactionsByBlockHashResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\ListXRPRippleTransactionsByBlockHashResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ListXRPRippleTransactionsByBlockHashResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function listXRPRippleTransactionsByBlockHashRequest($network, $block_hash, $context = null, $limit = 50, $offset = 0)
    {
        ...
        $resourcePath = '/blockchain-data/xrp/{network}/blocks/hash/{blockHash}/transactions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
