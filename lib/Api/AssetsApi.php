...
class AssetsApi
{
     ...
     */
    public function listAssetsDetailsWithHttpInfo($context = null, $asset_type = null, $limit = 50, $offset = 0)
    {
        $request = $this->listAssetsDetailsRequest($context, $asset_type, $limit, $offset);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ListAssetsDetailsResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ListAssetsDetailsResponse', []),
            ...
            $returnType = '\OpenAPI\Client\Model\ListAssetsDetailsResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ListAssetsDetailsResponse',
     ...
     */
    public function listAssetsDetailsAsync($context = null, $asset_type = null, $limit = 50, $offset = 0)
    {
        return $this->listAssetsDetailsAsyncWithHttpInfo($context, $asset_type, $limit, $offset)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listAssetsDetailsAsyncWithHttpInfo($context = null, $asset_type = null, $limit = 50, $offset = 0)
    {
        $returnType = '\OpenAPI\Client\Model\ListAssetsDetailsResponse';
        $request = $this->listAssetsDetailsRequest($context, $asset_type, $limit, $offset);
     ...
     */
    public function listAssetsDetailsRequest($context = null, $asset_type = null, $limit = 50, $offset = 0)
    {
