...
class AssetsApi
{
     ...
     * @throws \CryptoAPIs\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CryptoAPIs\Model\GetAssetDetailsByAssetSymbolR|\CryptoAPIs\Model\InlineResponse400114|\CryptoAPIs\Model\InlineResponse401114|\CryptoAPIs\Model\InlineResponse402|\CryptoAPIs\Model\InlineResponse403114|\CryptoAPIs\Model\InlineResponse409|\CryptoAPIs\Model\InlineResponse415|\CryptoAPIs\Model\InlineResponse422|\CryptoAPIs\Model\InlineResponse429|\CryptoAPIs\Model\InlineResponse500
     */
    ...
    public function getAssetDetailsByAssetSymbolWithHttpInfo($asset_symbol, $context = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\CryptoAPIs\Model\InlineResponse400114' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\CryptoAPIs\Model\InlineResponse400114', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
                    if ('\CryptoAPIs\Model\InlineResponse401114' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\CryptoAPIs\Model\InlineResponse401114', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 402:
                ...
                case 403:
                    if ('\CryptoAPIs\Model\InlineResponse403114' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\CryptoAPIs\Model\InlineResponse403114', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 409:
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CryptoAPIs\Model\InlineResponse400114',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CryptoAPIs\Model\InlineResponse401114',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CryptoAPIs\Model\InlineResponse403114',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
