...
class UTXOBasedApi
{
    ...
    public function getHDWalletXPubYPubZPubDetailsWithHttpInfo($blockchain, $extended_public_key, $network, $context = null, $derivation = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetHDWalletxPubYPubZPubDetailsResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetHDWalletxPubYPubZPubDetailsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\OpenAPI\Client\Model\XpubNotSynced' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\XpubNotSynced', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
                ...
                case 422:
                    if ('\OpenAPI\Client\Model\XpubSyncInProgress' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\XpubSyncInProgress', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 429:
            ...
            $returnType = '\OpenAPI\Client\Model\GetHDWalletxPubYPubZPubDetailsResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetHDWalletxPubYPubZPubDetailsResponse',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\XpubNotSynced',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 422:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\XpubSyncInProgress',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $network Represents the specific network. (required)
     * @param  string $context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param  string $derivation The way how the HD walled derives, for example when the type is ACCOUNT, it derives change and receive addresses while when the type is BIP32 it derives directly. (optional)
    ...
    public function listHDWalletXPubYPubZPubTransactionsWithHttpInfo($blockchain, $extended_public_key, $network, $context = null, $derivation = null, $limit = 50, $offset = 0)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ListHDWalletxPubYPubZPubTransactionsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ListHDWalletxPubYPubZPubTransactionsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\ListHDWalletxPubYPubZPubTransactionsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ListHDWalletxPubYPubZPubTransactionsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $network Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \&quot;mainnet\&quot; is the live network with actual data while networks like \&quot;testnet\&quot;, \&quot;ropsten\&quot;, \&quot;rinkeby\&quot; are test networks. (required)
     * @param  string $context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param  \OpenAPI\Client\Model\SyncHDWalletxPubYPubZPubRequestBody $sync_hd_walletx_pub_y_pub_z_pub_request_body sync_hd_walletx_pub_y_pub_z_pub_request_body (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SyncHDWalletxPubYPubZPubResponse|\OpenAPI\Client\Model\InvalidXpub|\OpenAPI\Client\Model\InvalidApiKey|\OpenAPI\Client\Model\InsufficientCredits|\OpenAPI\Client\Model\FeatureMainnetsNotAllowedForPlan|\OpenAPI\Client\Model\AlreadyExists|\OpenAPI\Client\Model\UnsupportedMediaType|\OpenAPI\Client\Model\XpubSyncInProgress|\OpenAPI\Client\Model\RequestLimitReached|\OpenAPI\Client\Model\UnexpectedServerError
     */
    public function syncHDWalletXPubYPubZPub($blockchain, $network, $context = null, $sync_hd_walletx_pub_y_pub_z_pub_request_body = null)
    {
        list($response) = $this->syncHDWalletXPubYPubZPubWithHttpInfo($blockchain, $network, $context, $sync_hd_walletx_pub_y_pub_z_pub_request_body);
        return $response;
    }
     ...
     * @param  string $network Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \&quot;mainnet\&quot; is the live network with actual data while networks like \&quot;testnet\&quot;, \&quot;ropsten\&quot;, \&quot;rinkeby\&quot; are test networks. (required)
     * @param  string $context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param  \OpenAPI\Client\Model\SyncHDWalletxPubYPubZPubRequestBody $sync_hd_walletx_pub_y_pub_z_pub_request_body (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\SyncHDWalletxPubYPubZPubResponse|\OpenAPI\Client\Model\InvalidXpub|\OpenAPI\Client\Model\InvalidApiKey|\OpenAPI\Client\Model\InsufficientCredits|\OpenAPI\Client\Model\FeatureMainnetsNotAllowedForPlan|\OpenAPI\Client\Model\AlreadyExists|\OpenAPI\Client\Model\UnsupportedMediaType|\OpenAPI\Client\Model\XpubSyncInProgress|\OpenAPI\Client\Model\RequestLimitReached|\OpenAPI\Client\Model\UnexpectedServerError, HTTP status code, HTTP response headers (array of strings)
     */
    public function syncHDWalletXPubYPubZPubWithHttpInfo($blockchain, $network, $context = null, $sync_hd_walletx_pub_y_pub_z_pub_request_body = null)
    {
        $request = $this->syncHDWalletXPubYPubZPubRequest($blockchain, $network, $context, $sync_hd_walletx_pub_y_pub_z_pub_request_body);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Model\SyncHDWalletxPubYPubZPubResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\SyncHDWalletxPubYPubZPubResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\OpenAPI\Client\Model\InvalidXpub' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\InvalidXpub', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\OpenAPI\Client\Model\SyncHDWalletxPubYPubZPubResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\SyncHDWalletxPubYPubZPubResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\InvalidXpub',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function syncHDWalletXPubYPubZPubAsync($blockchain, $network, $context = null, $sync_hd_walletx_pub_y_pub_z_pub_request_body = null)
    {
        return $this->syncHDWalletXPubYPubZPubAsyncWithHttpInfo($blockchain, $network, $context, $sync_hd_walletx_pub_y_pub_z_pub_request_body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function syncHDWalletXPubYPubZPubAsyncWithHttpInfo($blockchain, $network, $context = null, $sync_hd_walletx_pub_y_pub_z_pub_request_body = null)
    {
        $returnType = '\OpenAPI\Client\Model\SyncHDWalletxPubYPubZPubResponse';
        $request = $this->syncHDWalletXPubYPubZPubRequest($blockchain, $network, $context, $sync_hd_walletx_pub_y_pub_z_pub_request_body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function syncHDWalletXPubYPubZPubRequest($blockchain, $network, $context = null, $sync_hd_walletx_pub_y_pub_z_pub_request_body = null)
    {
        // verify the required parameter 'blockchain' is set
        if ($blockchain === null || (is_array($blockchain) && count($blockchain) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // for model (json/xml)
        if (isset($sync_hd_walletx_pub_y_pub_z_pub_request_body)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($sync_hd_walletx_pub_y_pub_z_pub_request_body));
            } else {
                $httpBody = $sync_hd_walletx_pub_y_pub_z_pub_request_body;
            }
