...
class ValidatingApi
{
     ...
     * @param  \OpenAPI\Client\Model\ValidateAddressRequestBody $validate_address_request_body validate_address_request_body (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ValidateAddressResponse|\OpenAPI\Client\Model\InvalidPagination|\OpenAPI\Client\Model\InvalidApiKey|\OpenAPI\Client\Model\InsufficientCredits|\OpenAPI\Client\Model\FeatureMainnetsNotAllowedForPlan|\OpenAPI\Client\Model\InvalidData|\OpenAPI\Client\Model\UnsupportedMediaType|\OpenAPI\Client\Model\InvalidRequestBodyStructure|\OpenAPI\Client\Model\RequestLimitReached|\OpenAPI\Client\Model\UnexpectedServerError
     */
    public function validateAddress($blockchain, $network, $context = null, $validate_address_request_body = null)
    {
        list($response) = $this->validateAddressWithHttpInfo($blockchain, $network, $context, $validate_address_request_body);
        return $response;
    }
     ...
     * @param  string $network Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \&quot;mainnet\&quot; is the live network with actual data while networks like \&quot;testnet\&quot;, \&quot;ropsten\&quot;, \&quot;rinkeby\&quot; are test networks. (required)
     * @param  string $context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param  \OpenAPI\Client\Model\ValidateAddressRequestBody $validate_address_request_body (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ValidateAddressResponse|\OpenAPI\Client\Model\InvalidPagination|\OpenAPI\Client\Model\InvalidApiKey|\OpenAPI\Client\Model\InsufficientCredits|\OpenAPI\Client\Model\FeatureMainnetsNotAllowedForPlan|\OpenAPI\Client\Model\InvalidData|\OpenAPI\Client\Model\UnsupportedMediaType|\OpenAPI\Client\Model\InvalidRequestBodyStructure|\OpenAPI\Client\Model\RequestLimitReached|\OpenAPI\Client\Model\UnexpectedServerError, HTTP status code, HTTP response headers (array of strings)
     */
    public function validateAddressWithHttpInfo($blockchain, $network, $context = null, $validate_address_request_body = null)
    {
        $request = $this->validateAddressRequest($blockchain, $network, $context, $validate_address_request_body);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ValidateAddressResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ValidateAddressResponse', []),
            ...
            $returnType = '\OpenAPI\Client\Model\ValidateAddressResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ValidateAddressResponse',
     ...
     */
    public function validateAddressAsync($blockchain, $network, $context = null, $validate_address_request_body = null)
    {
        return $this->validateAddressAsyncWithHttpInfo($blockchain, $network, $context, $validate_address_request_body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function validateAddressAsyncWithHttpInfo($blockchain, $network, $context = null, $validate_address_request_body = null)
    {
        $returnType = '\OpenAPI\Client\Model\ValidateAddressResponse';
        $request = $this->validateAddressRequest($blockchain, $network, $context, $validate_address_request_body);
     ...
     */
    public function validateAddressRequest($blockchain, $network, $context = null, $validate_address_request_body = null)
    {
        ...
        // for model (json/xml)
        if (isset($validate_address_request_body)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($validate_address_request_body));
            } else {
                $httpBody = $validate_address_request_body;
            }
