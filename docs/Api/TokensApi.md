...
```php
getTokenDetailsByContractAddress($blockchain, $network, $contract_address, $context): \CryptoAPIs\Model\GetTokenDetailsByContractAddressR
```
...
[**\CryptoAPIs\Model\GetTokenDetailsByContractAddressR**](../Model/GetTokenDetailsByContractAddressR.md)
...
```php
listConfirmedTokensTransfersByAddress($blockchain, $network, $address, $context, $limit, $offset): \CryptoAPIs\Model\ListConfirmedTokensTransfersByAddressR
```
...
[**\CryptoAPIs\Model\ListConfirmedTokensTransfersByAddressR**](../Model/ListConfirmedTokensTransfersByAddressR.md)
